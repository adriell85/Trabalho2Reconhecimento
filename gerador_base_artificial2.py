...
def gerar_dataset():
    ...
    x1_classe_0 = np.random.uniform(0, 10, num_amostras_classe_0)
    x2_classe_0 = np.random.uniform(0, 5, num_amostras_classe_0)
    labels_classe_0 = np.zeros(num_amostras_classe_0, dtype=int)


    x1_classe_1 = np.random.uniform(15, 25, num_amostras_classe_1)
    x2_classe_1 = np.random.uniform(0, 10, num_amostras_classe_1)
    labels_classe_1 = np.ones(num_amostras_classe_1, dtype=int)


    x1_classe_2 = np.random.uniform(0, 5, num_amostras_classe_2)
    x2_classe_2 = np.random.uniform(10, 15, num_amostras_classe_2)
